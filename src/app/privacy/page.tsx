...
const sections = [
  ...
  {
    title: '6. Your Rights',
    body: 'You have the right to: access the personal data we hold about you, request correction of inaccurate data, request deletion of your data, opt out of communications, and lodge a complaint with a supervisory authority. To exercise these rights, contact us at hello@globalnexus.one.',
  },
  {
